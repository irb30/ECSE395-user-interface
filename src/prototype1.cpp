...
// Interface Prototype 1: This prototype tested photoresistor, touch module, LED, and LCD
...
void loop () {
   ...
   // Output: Message on the LCD screen alternates with weight displayed
    ...
    if (analogRead(touchPin) > 1500) {
        ...
        int potValue = analogRead(sensorPin); // Read photoresistor value 
    ...
    // Output: Message on the LCD screen alternates with weight displayed
        ...
        int potValue = analogRead(sensorPin); // Read photoresistor values
